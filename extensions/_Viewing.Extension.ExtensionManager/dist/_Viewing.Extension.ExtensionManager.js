window["_Viewing.Extension.ExtensionManager"] =
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Viewing.Extension.ExtensionManager/Viewing.Extension.ExtensionManager.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/Viewing.Extension.ExtensionManager lazy recursive":
/*!**********************************************************************!*\
  !*** ./src/Viewing.Extension.ExtensionManager lazy namespace object ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
webpackEmptyAsyncContext.id = "./src/Viewing.Extension.ExtensionManager lazy recursive";
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ExtensionManagerPanel; });
...
var ExtensionManagerPanel =
/*#__PURE__*/
function (_ToolPanelBase) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(ExtensionManagerPanel, _ToolPanelBase);

  function ExtensionManagerPanel(container, btnElement) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ExtensionManagerPanel);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(ExtensionManagerPanel).call(this, container, 'Extension Manager', {
      buttonElement: btnElement,
      shadow: true
    }));
    $(_this.container).addClass('extension-manager');
    $('#' + _this.container.id + '-filter').on('input', function () {
      _this.filterItems();
    });
    return _this;
  } /////////////////////////////////////////////////////////////
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ExtensionManagerPanel, [{
    key: "htmlContent",
    value: function htmlContent(id) {
      return "\n\n      <div class=\"container\">\n        <input id=\"".concat(id, "-filter\" type=\"text\" class=\"filter\"\n               placeholder=\" Search Extensions ...\">\n        <div class=\"item-list\" id=\"").concat(id, "-item-list\">\n        </div>\n      </div>");
    } /////////////////////////////////////////////////////////////
    //
    //
    /////////////////////////////////////////////////////////////
    ...
    key: "addItem",
    value: function addItem(extension) {
      var _this3 = this;

      var itemId = extension._id;
      var itemHtml = "\n      <div id=\"".concat(itemId, "\" class=\"list-group-item\">\n        ").concat(extension.name, "\n      </div>\n    ");
      $("#".concat(this.container.id, "-item-list")).append(itemHtml);
      var $item = $("#".concat(itemId));
      $item.addClass(extension.enabled ? 'enabled' : '');
      $item.click(function (e) {
        e.preventDefault();
        extension.enabled ? _this3.emit('unload-request', extension) : _this3.emit('load-request', extension);
      });
    } /////////////////////////////////////////////////////////////
    //
    //
    ...
    key: "updateItem",
    value: function updateItem(extension) {
      var $item = $("#".concat(extension._id));
      extension.enabled ? $item.addClass('enabled') : $item.removeClass('enabled');
    } /////////////////////////////////////////////////////////////
    //
    //
    /////////////////////////////////////////////////////////////
...
/* harmony import */ var _Viewing_Extension_ExtensionManager_Panel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Viewing.Extension.ExtensionManager.Panel */ "./src/Viewing.Extension.ExtensionManager/Viewing.Extension.ExtensionManager.Panel.js");
/* harmony import */ var Viewer_ExtensionBase__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! Viewer.ExtensionBase */ "./src/components/Viewer.ExtensionBase/index.js");
/* harmony import */ var Viewer_Toolkit__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! Viewer.Toolkit */ "./src/components/Viewer.Toolkit/index.js");
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! debug */ "./node_modules/debug/browser.js");
...
var debug = debug__WEBPACK_IMPORTED_MODULE_10___default()('Viewing.Extension.ExtensionManager'); ////////////////////////////////////////////////////////////////
// ExtensionManager API
//
/////////////////////////////////////////////////////////////////

var ExtensionManagerAPI =
/*#__PURE__*/
function () {
  function ExtensionManagerAPI(apiUrl) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, ExtensionManagerAPI);

    this._apiUrl = apiUrl;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(ExtensionManagerAPI, [{
    key: "getExtensions",
    ...
    key: "getScriptUrl",
    value: function getScriptUrl(extension) {
      var url = this._apiUrl + '/extensions/script/' + extension.id;
      return url;
    }
  }]);

  return ExtensionManagerAPI;
}();

var ExtensionManager =
/*#__PURE__*/
function (_ExtensionBase) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(ExtensionManager, _ExtensionBase);
  ...
  function ExtensionManager(viewer, options) {
    ...
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_5___default()(this, ExtensionManager);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(ExtensionManager).call(this, viewer, options));
    _this._api = new ExtensionManagerAPI(options.apiUrl);
    _this._options.enabledList = options.enabledList || [];
    _this._options.defaultOptions = options.defaultOptions || {};

    if (_this._options.storage.enabled) {
      _this._storedExtensions = _this._options.storage.Lockr.get(_this._options.storage.key) || {};
    }
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_6___default()(ExtensionManager, [{
    key: "load",
    /////////////////////////////////////////////////////////////////
    // Load callback
    //
    ...
    value: function load() {
      ...
      this._viewer.loadManagedExtension = function (id, options) {
        if (_this2._extensionsMap[id]) {
          return _this2.loadManagedExtension(_this2._extensionsMap[id], options);
        }
      };

      this._viewer.unloadManagedExtension = function (id) {
        if (_this2._extensionsMap[id]) {
          return _this2.unloadManagedExtension(_this2._extensionsMap[id]);
        }
      };
      ...
      this._options.waitEventsList.forEach(function (event) {
        _this2._eventsMap[event] = false;

        var handler = function handler() {
          _this2._viewer.removeEventListener(event, handler);

          _this2._eventsMap[event] = true;

          _this2._loadingQueue.forEach(function (loadInfo, idx, arr) {
            var load = true;
            loadInfo.waitEvents.forEach(function (waitEvent) {
              if (!_this2._eventsMap[waitEvent]) load = false;
            });
        ...
        _this2._viewer.addEventListener(event, handler);
      });

      this._api.getExtensions().then(function (extensions) {
        _this2.initializeExtensions(extensions);
      });
    ...
    value: function onToolbarCreated() {
      ...
      if (this._options.visible) {
        this._control = Viewer_Toolkit__WEBPACK_IMPORTED_MODULE_9__["default"].createButton('extension-manager-control', 'glyphicon glyphicon-plus', 'Manage Extensions', function () {
          _this3._panel.toggleVisibility();
        });
        this._panel = new _Viewing_Extension_ExtensionManager_Panel__WEBPACK_IMPORTED_MODULE_7__["default"](this._viewer.container, this._control.container);

        this._panel.on('load-request', this.onLoadRequest.bind(this));

        this._panel.on('unload-request', this.onUnloadRequest.bind(this));

        var viewerToolbar = this._viewer.getToolbar(true);

        viewerToolbar.addControl(this._options.parentControl);

        this._options.parentControl.addControl(this._control);
      }
    } /////////////////////////////////////////////////////////////////
    //
    //
    ...
    key: "initializeExtensions",
    value: function initializeExtensions(extensions) {
      var _this4 = this;

      var loadTasks = extensions.map(function (extension) {
        _this4._extensionsMap[extension.id] = extension;
        var enable = false;

        if (_this4._options.enabledList.indexOf(extension.id) > -1) {
          enable = !_this4._options.storage.enabled || !_this4._storedExtensions[extension.id] || _this4._storedExtensions[extension.id].enabled;
        } else {
          enable = _this4._options.storage.enabled && _this4._storedExtensions[extension.id] && _this4._storedExtensions[extension.id].enabled;
        }

        if (enable) {
          return _this4.loadManagedExtension(extension);
        }

        return Promise.resolve();
      });
      Promise.all(loadTasks).then(function (results) {
        _this4.emit('allExtensionsLoaded', results);
      });
      var visibleExtensions = extensions.filter(function (extension) {
        return _this4._options.showHidden || extension.id.indexOf('_') != 0;
      });
    ...
    value: function unload() {
      this._options.parentControl.removeControl(this._control);
    ...
    key: "onLoadRequest",
    value: function () {
      var _onLoadRequest = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(extension) {
        var res;
    ...
    key: "onUnloadRequest",
    value: function onUnloadRequest(extension) {
    ...
    key: "loadManagedExtension",
    value: function loadManagedExtension(extension, options) {
      var _this5 = this;
      ...
      function () {
        ...
        _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(resolve, reject) {
          var scriptUrl, defaultOptions, options, _resolve, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, event;
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                  scriptUrl = _this5._api.getScriptUrl(extension);
                  _context2.next = 6;
                  return __webpack_require__("./src/Viewing.Extension.ExtensionManager lazy recursive")(scriptUrl);

                case 6:
                  defaultOptions = _this5._options.defaultOptions[extension.id] || {};
                  options = Object.assign({
                    mobile: Viewer_Toolkit__WEBPACK_IMPORTED_MODULE_9__["default"].mobile
                  }, _this5._options, extension.options, defaultOptions, options);

                  _resolve = function _resolve() {
                    try {
                      var res = _this5._viewer.loadExtension(extension.id, options);

                      extension.enabled = res;

                      _this5.updateStorage(extension);

                      if (_this5._options.visible) _this5._panel.updateItem(extension);
                      return resolve(res);
                    } catch (ex) {
                      debug(ex);
                      reject(ex);
                  ...
                  _context2.prev = 13;
                  _iterator = options.waitEvents[Symbol.iterator]();
                ...
                case 15:
                  ...
                  if (_this5._eventsMap[event]) {
                    _context2.next = 20;
                    break;
                  }

                  _this5._loadingQueue.push({
                ...
                case 37:
                  return _context2.abrupt("return", _resolve());
          ...
          }, _callee2, null, [[0, 43], [13, 25, 29, 37], [30,, 32, 36]]);
        }));
    ...
    key: "unloadManagedExtension",
    value: function unloadManagedExtension(extension) {
      var res = this._viewer.unloadExtension(extension.id);

      extension.enabled = false;
      this.updateStorage(extension);
      if (this._options.visible) this._panel.updateItem(extension);
    } /////////////////////////////////////////////////////////////////
    //
    //
    /////////////////////////////////////////////////////////////////
    ...
    key: "updateStorage",
    value: function updateStorage(extension) {
      if (this._options.storage.enabled) {
        this._storedExtensions[extension.id] = {
          enabled: extension.enabled
        };

        this._options.storage.Lockr.set(this._options.storage.key, this._storedExtensions);
      }
    }
  }], [{
    key: "ExtensionId",
...
}(Viewer_ExtensionBase__WEBPACK_IMPORTED_MODULE_8__["default"]);
