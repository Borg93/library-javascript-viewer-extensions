window["Viewing.Extension.CustomTree"] =
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Viewing.Extension.CustomTree/Viewing.Extension.CustomTree.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./src/Viewing.Extension.CustomTree/Viewing.Extension.CustomTree.css":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./src/Viewing.Extension.CustomTree/Viewing.Extension.CustomTree.css ***!
  \***********************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CustomTreePanel; });
...
/* harmony import */ var _Viewing_Extension_CustomTree_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Viewing.Extension.CustomTree.css */ "./src/Viewing.Extension.CustomTree/Viewing.Extension.CustomTree.css");
/* harmony import */ var _Viewing_Extension_CustomTree_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_Viewing_Extension_CustomTree_css__WEBPACK_IMPORTED_MODULE_5__);
...
function (_ToolPanelBase) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(CustomTreePanel, _ToolPanelBase);

  function CustomTreePanel(viewer, btnElement, rootNode) {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, CustomTreePanel);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(CustomTreePanel).call(this, viewer.container, 'Custom Tree', {
      buttonElement: btnElement,
      shadow: true
    }));
    $(_this.container).addClass('custom-tree');
    var treeContainer = $("#".concat(_this.container.id, "-tree-container"))[0];
    _this.treeDelegate = new CustomTreeDelegate(viewer);
    _this.tree = new Autodesk.Viewing.UI.Tree(_this.treeDelegate, rootNode, treeContainer, {
      excludeRoot: false,
      localize: true
    });
    return _this;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(CustomTreePanel, [{
    key: "htmlContent",
    value: function htmlContent(id) {
      return "\n      <div class=\"container\" id=\"".concat(id, "-tree-container\">\n      </div>\n    ");
    }
  }]);

  return CustomTreePanel;
}(ToolPanelBase__WEBPACK_IMPORTED_MODULE_6__["default"]);



var CustomTreeDelegate =
/*#__PURE__*/
function (_Autodesk$Viewing$UI$) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(CustomTreeDelegate, _Autodesk$Viewing$UI$);

  function CustomTreeDelegate(viewer) {
    var _this2;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, CustomTreeDelegate);

    _this2 = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(CustomTreeDelegate).call(this));
    _this2.viewer = viewer;
    return _this2;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(CustomTreeDelegate, [{
    key: "getTreeNodeId",
    ...
    key: "forEachChild",
    value: function forEachChild(node, callback) {
      if (node.children) {
  ...
  return CustomTreeDelegate;
}(Autodesk.Viewing.UI.TreeDelegate);
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js??ref--6-1!../../node_modules/postcss-loader/src??ref--6-2!./Viewing.Extension.CustomTree.css */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./src/Viewing.Extension.CustomTree/Viewing.Extension.CustomTree.css");
...
/* harmony import */ var _Viewing_Extension_CustomTree_Panel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Viewing.Extension.CustomTree.Panel */ "./src/Viewing.Extension.CustomTree/Viewing.Extension.CustomTree.Panel.js");
...
var CustomTreeExtension =
/*#__PURE__*/
function (_ExtensionBase) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(CustomTreeExtension, _ExtensionBase);

  /////////////////////////////////////////////////////////////////
  // Class constructor
  //
  /////////////////////////////////////////////////////////////////
  function CustomTreeExtension(viewer, options) {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, CustomTreeExtension);

    return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(CustomTreeExtension).call(this, viewer, options));
  } /////////////////////////////////////////////////////////////////
  // Extension Id
  //
  /////////////////////////////////////////////////////////////////
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(CustomTreeExtension, [{
    key: "load",
    /////////////////////////////////////////////////////////////////
    // Load callback
    //
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this._viewer.search('Levels: 1/4" Head', function (dbIdArray) {
                  //var rootNode = await ViewerToolkit.buildModelTree(
                  //  this._viewer.model)
                  var instanceTree = _this._viewer.model.getData().instanceTree;
                  ...
                  dbIdArray.forEach(function (dbId) {
                    var node = {
                      dbId: dbId,
                      name: instanceTree.getNodeName(dbId)
                    };

                    _this.buildNodeTreeRec(instanceTree, node);

                    rootNode.children.push(node);
                  });
                  _this.panel = new _Viewing_Extension_CustomTree_Panel__WEBPACK_IMPORTED_MODULE_7__["default"](_this._viewer, null, rootNode);
    ...
    key: "buildNodeTreeRec",
    value: function buildNodeTreeRec(instanceTree, node) {
      var _this2 = this;
      ...
      instanceTree.enumNodeChildren(node.dbId, function (childId) {
        ...
        _this2.buildNodeTreeRec(instanceTree, childNode);
      });
    }
  }], [{
    key: "ExtensionId",
  ...
  return CustomTreeExtension;
}(Viewer_ExtensionBase__WEBPACK_IMPORTED_MODULE_8__["default"]);

Autodesk.Viewing.theExtensionManager.registerExtension(CustomTreeExtension.ExtensionId, CustomTreeExtension);
